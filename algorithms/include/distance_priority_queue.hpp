...
namespace Algorithms {
    ...
    public:
        bool operator() (DistanceCell a, DistanceCell b) {
            ...
            // We return true, because if we would use < instead and return it then, we would keep getting the pairs with the maximum distance.
            // That is because by default the priority queue is maximum priority queue, and it thinks that we will use the <.
            // If you want to find the longest distance instead of the shortest, then change this to <.
